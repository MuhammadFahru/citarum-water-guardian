...
@section('content')
    ...
    >
        ...
        <a href="{{ route('dashboard') }}" class="btn btn-warning mr-3 d-none" id="syncSensor"><i class="fas fa-sync-alt mr-1"></i> Reconnect to Sensor</a>
    </div>
    <div class="row">
        <div class="col-lg-4 col-12">
            <div class="card shadow mb-3 p-5 text-center rounded light-primary">
                <h3 class="mb-3">Last Updated</h3>
                <h5 class="dataTime mb-0">-</h5>
            </div>
        </div>
        <div class="col-lg-4 col-12">
            <div class="card shadow mb-3 p-5 text-center rounded" id="cardStatusAir">
                <h3 class="mb-3">Status Air</h3>
                <h5 id="textStatusAir" class="mb-0">-</h5>
            </div>
        </div>
        <div class="col-lg-4 col-12">
            <div class="card shadow mb-3 p-5 text-center rounded" id="cardStatusConnection">
